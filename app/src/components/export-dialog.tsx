  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh]">
        ...
        <Tabs value={format} onValueChange={value => setFormat(value as ExportFormat)} className="flex-1">
          ...
          <TabsContent value={format} className="mt-4">
            <div className="relative">
              <pre className="p-4 bg-muted rounded-lg overflow-auto max-h-[50vh] text-sm">
                <code>{template}</code>
              </pre>
            </div>
          </TabsContent>
