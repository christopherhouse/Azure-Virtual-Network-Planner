...
def valid_delegations_json() -> dict:
    ...
    return {
        "id": "delegations",
        "type": "delegations",
        "data": [{"id": "none", "name": "None", "serviceName": "", "description": "No delegation"}],
    }
...
class TestLoadJsonFile:
    ...
    def test_load_valid_json(
        self, temp_data_dir: TemporaryDirectory, valid_delegations_json: dict
    ) -> None:
...
class TestSyncReferenceDataDryRun:
    ...
    def test_dry_run_valid_files(
        ...
        result = sync_reference_data(
            endpoint="https://test.documents.azure.com:443/", data_dir=data_path, dry_run=True
        )
...
class TestSyncReferenceDataLive:
    ...
    def test_sync_upserts_documents(
        ...
        result = sync_reference_data(
            endpoint="https://test.documents.azure.com:443/", data_dir=data_path, dry_run=False
        )
